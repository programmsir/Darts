...
# герой
hero = Sprite(200, 320, 'oxotnik.png')
hero.right = True
hero.up = True
# враг
enemy = Sprite(10, 10, 'DARTS.png')
enemy.right = True
enemy.step = 1
# оружие
weapon = Sprite(-10, 350, 'pylu.png')
weapon.push = False
weapon.n = 5
...
pygame.mixer.init()
sound = pygame.mixer.Sound('004_13082.mp3')
load_menu()
running = True
...
while running:
    ...
    boom = boomFont.render("shot", 1, [255, 0, 0])
